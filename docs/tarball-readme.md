...
It does not include Herdr itself. Start or attach a Herdr `v0.9.0` or newer session that reports
terminal protocol `22` separately before running this bundle.
