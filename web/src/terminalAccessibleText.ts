...
/**
 * Returns the active terminal viewport as bounded plain text.
 *
 * The newest portion of an unusually large viewport is retained so the active
 * prompt remains available. Empty cells become spaces, trailing whitespace is
 * removed per row, and blank rows at the bottom of the screen are omitted.
 */
